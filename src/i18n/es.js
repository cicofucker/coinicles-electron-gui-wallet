export default {
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Coinicles",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "coiniclesd no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    serviceNodeRegistrationDescription:
      'Introduzca la orden {registerCommand} generada por el servicio (coiniclesd) que se está intentado registrar como Nodo de Servicio usando la instrucción "{prepareCommand}"',
    spendKey: "Clave de gasto",
